...
export const zhNavbar = defineNavbarConfig([
  { text: '首页', link: '/zh/', icon: 'carbon:home' },
  { text: '博客', link: '/zh/blog/', icon: 'carbon:blog' },
  { text: '笔记', link: '/zh/learning-notes/', icon: 'carbon:notebook' },
  { text: '利器', link: '/zh/uses/', icon: 'carbon:tool-kit' },
  { text: '分类', link: '/zh/blog/categories/', icon: 'bx:category' },
...
export const enNavbar = defineNavbarConfig([
  ...
  { text: 'Notes', link: '/learning-notes/', icon: 'carbon:notebook' },
  { text: 'Uses', link: '/uses/', icon: 'carbon:tool-kit' },
